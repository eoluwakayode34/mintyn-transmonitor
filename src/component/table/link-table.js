            ...
            <Tbody {...getTableBodyProps()}>
                ...
                <Flex flexWrap='wrap' px={['1rem','1.5rem','2rem']}  py={['.5rem','1rem','1.5rem']} flex='1' alignItems='center' justifyContent='space-between'>
                    ...
                    <Flex flex={['3','2','1','1']}>
                        ...
                        <Text fontSize='14px' > Go to Page</Text>

                            <Input display='flex' mx='1rem' textAlign='center' alignItems='center' justifyContent='center' type='number'  flex='1' width='4rem'  p={0} defaultValue={pageIndex + 1}
                            onChange={e => {
